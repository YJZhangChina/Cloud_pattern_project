 ...
 * @author benjamin
 */
public class RequestPriorityQueueRobinProxy {
    ...
    private static RequestPriorityQueueRobinProxy instance = null;

    private RequestPriorityQueueRobinProxy() {
        ...
        t1 = new Thread(new QueueConsumer(robinProx, queue));
        t2 = new Thread(new QueueConsumer(robinProx, queue));
        t3 = new Thread(new QueueConsumer(robinProx, queue));
        t4 = new Thread(new QueueConsumer(robinProx, queue));
        t5 = new Thread(new QueueConsumer(robinProx, queue));
        t6 = new Thread(new QueueConsumer(robinProx, queue));
        t7 = new Thread(new QueueConsumer(robinProx, queue));
        t8 = new Thread(new QueueConsumer(robinProx, queue));
        t9 = new Thread(new QueueConsumer(robinProx, queue));
        t10 = new Thread(new QueueConsumer(robinProx, queue));
    }

    public static RequestPriorityQueueRobinProxy getInstance() {
        if (instance == null) {
            instance = new RequestPriorityQueueRobinProxy();
        }
        return instance;
    }
