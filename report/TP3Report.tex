...
The following table display the results of our benchmarking process. As you can see, we ran each thread and each request for 5 time. The top half of the tables represent the response time for 5,000 requests, while the bottom part represents the response time for 10,000 requets. 
