...
Finally, we sum the energy consumed in each of the seconds by the subject process to obtain the total energy consumed by a MySQL data node in terms of CPU.
